...
namespace BlogProject.Data.Migrations
{
    ...
    [Migration("20231102051159_updateImageInPost")]
    partial class updateImageInPost
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogProject.Data.Entities.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "35be0df0-ef38-44ec-abbc-9a7243dd492e",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELSF+nCHW2+PqDHdO6YDEzAJQAEwmCZ/zM7PPer21sUwSf3ZI0KrRn97jQ7c6dz0iQ==",
            ...
            modelBuilder.Entity("BlogProject.Data.Entities.CategoriesDetail", b =>
                {
            ...
            modelBuilder.Entity("BlogProject.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "6505d803-5154-45e5-a19e-8d76a1ce79c6",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "1c0688ce-ef92-42c7-a429-d9204705e490",
            ...
            modelBuilder.Entity("BlogProject.Data.Entities.CategoriesDetail", b =>
                {
                    b.HasOne("BlogProject.Data.Entities.Category", "Category")
            ...
            modelBuilder.Entity("BlogProject.Data.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("BlogProject.Data.Entities.AppUser", "User")
                        .WithMany("Comment")
            ...
            modelBuilder.Entity("BlogProject.Data.Entities.Follow", b =>
                {
                    b.HasOne("BlogProject.Data.Entities.AppUser", "Followee")
                        .WithMany("Follower")
                        .HasForeignKey("FolloweeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlogProject.Data.Entities.AppUser", "Follower")
                        .WithMany("Followee")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("BlogProject.Data.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
